/**
 * Chat Header Component (v3.5.2)
 *
 * Extracted from Chat.tsx for better maintainability.
 * Contains navigation controls and settings buttons.
 */
...
interface ChatHeaderProps {
  /** Whether conversation history sidebar is visible */
  showConversationHistory: boolean;
  /** Whether tool history sidebar is visible */
  ...
  return (
    <header className="border-b border-border bg-card px-6 py-4 flex items-center justify-between titlebar-drag">
      ...
      <div className="flex items-center gap-4 titlebar-no-drag">
        ...
        <ModeIndicator isTracking={isTracking} onToggle={onToggleTracking} />
        ...
        >
          <ToolHistoryIcon isActive={showToolHistory} />
        </Button>
...
function ToolHistoryIcon({ isActive }: { isActive: boolean }) {
  return (
    <svg
      width="18"
      height="18"
