 ...
 * SQLite database structure for Garden of Eden V3
 */
...
export const createTableStatements = {
   ...
   * Stores custom persona parameters
   */
  persona_settings: `
   ...
   * Stores important facts and events for RAG
   */
  episodic_memory: `
  ...
  /**
   * Learning data table
   * Stores feedback and learning metrics
   */
  learning_data: `
   ...
   * Stores screen capture analysis
   */
  screen_context: `
 ...
 */
export function getInitializationStatements(): string[] {
  return [
    ...Object.values(createTableStatements),
    ...Object.values(createIndexStatements),
  ];
}
